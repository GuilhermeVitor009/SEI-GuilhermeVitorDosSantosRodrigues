...
while not game_over:
    ...
    for event in pygame.event.get():
        ...
        if event.type == KEYDOWN:
            if comando[pygame.K_UP and my_direction != DOWN:
                my_direction= UP
            if comando[pygame.K_DOWN and my_direction != UP:
                my_direction= DOWN
            if comando[pygame.K_LEFT and my_direction != RIGHT:
                my_direction= LEFT
            if comando[pygame.K_RIGHT and my_direction != LEFT:
                my_direction= RIGHT
